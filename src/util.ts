...
export function loadFile(uri: string, responseType:XMLHttpRequestResponseType = "text") {
...
export let loadBytes = (uri: string) => loadFile(uri, "arraybuffer") as Promise<ArrayBuffer>